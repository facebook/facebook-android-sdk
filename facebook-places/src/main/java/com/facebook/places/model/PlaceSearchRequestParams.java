...
/**
 * Describes the parameters to create a place search request with {@link
...
public final class PlaceSearchRequestParams {
  ...
  /**
   * Gets the maximum distance (in meters) from the location specified. This can be used only in
   * conjunction with a location.
   *
  ...
  /** Gets the name of the place to search for. @@return The name of the place to search for. */
  ...
  public static class Builder {
    ...
    /**
     * Sets the maximum search radius in meters. If {@code PlaceManager.newPlaceSearchRequest()} is
     * used, then this parameter defines the maximum search radius around the current device
    ...
    /**
     * Sets the name of the place to search for. If this parameter is not specified, then you must
     * supply a location, and the response will contain places that are near the given location.
     *
    ...
    /**
     * Add a place information field to the list of fields to be returned. Refer to {@link
     * PlaceFields} for a list of fields. Refer to the online Places Graph documentation for the
     * current list of supported fields.
     *
