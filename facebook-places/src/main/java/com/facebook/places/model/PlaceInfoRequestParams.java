...
/**
 * Describes the parameters used to create a place info request with {@link
...
public final class PlaceInfoRequestParams {
  ...
  public static class Builder {
    ...
    /**
     * Add a field to be returned in the response data. See {@link PlaceFields} for a list of known
     * fields. Refer to the online Places Graph documentation for an up to date list of fields.
     *
    ...
    /**
     * Add a list of fields to be returned in the response data. See {@link PlaceFields} for a list
     * of known fields. Refer to the online Places Graph documentation for an up to date list of
     * fields.
     *
