...
/**
 * Describes the fields available when searching for a place, or when querying a place's'
 * information with {@link com.facebook.places.PlaceManager}. Refer to the online Places Graph
 * documentation to get the complete list of supported place fields.
 */
public interface PlaceFields {
  ...
  /**
   * To be used on the current_place request. Indicates the confidence level of the current place
   * result.
   */
  ...
  /**
   * Engagement. The social sentence and like count information for this place. This is the same
   * information used for the Like button.
   */
  String ENGAGEMENT = "engagement";

  /**
   * Specifies a single range of open hours per day. Each day can have two different hours ranges.
   * The keys in the map are in the form of {day}_{number}_{status}. {day} should be the first 3
   * characters of the day of the week, {number} should be either 1 or 2 to allow for the two
   * different hours ranges per day. {status} should be either open or close, to delineate the start
   * or end of a time range. An example would be mon_1_open with value 17:00 and mon_1_close with
   * value 21:15 which would represent a single opening range of 5 PM to 9:15 PM on Mondays.
   */
  String HOURS = "hours";
  ...
  /**
   * The categories that this place matched. To be used on the search request if the categories
  ...
  /**
   * Overall page rating based on a rating survey from users, on a scale of 1-5. This value is
   * normalized, and is not guaranteed to be a strict average of user ratings.
   */
  ...
  /**
   * Price range of the business. Applicable to Restaurants or Nightlife. Can be one of $ (0-10), $$
   * (10-30), $$$ (30-50), $$$$ (50+), or Unspecified.
   */
