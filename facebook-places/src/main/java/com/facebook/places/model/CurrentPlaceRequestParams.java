...
/**
 * Describes the parameters of the current place request. Use {@link
 * com.facebook.places.PlaceManager} to create a new current place request.
 */
public class CurrentPlaceRequestParams {
   ...
   *
   * <p>A place with field {@code CONFIDENCE_LEVEL} set to {@code HIGH} indicates that there is a
  ...
  public enum ScanMode {
    ...
    /**
     * In high accuracy mode, {@link com.facebook.places.PlaceManager}, scans for nearby Wi-Fi and
     * Bluetooth Low Energy beacons to maximize the accuracy of the current place request. High
     * accuracy mode is the default value.
     */
    HIGH_ACCURACY,

    /**
     * In low latency mode, {@link com.facebook.places.PlaceManager}, reduces nearby Wi-Fi and
     * Bluetooth beacon scanning to a minimum to prioritize low latency rather than accuracy. Using
     * low latency mode reduces the maximum time taken to generate the current place request. To
     * minimize latency mode, a location must be specified on the {@link Builder}.
     */
    LOW_LATENCY,
  }
  ...
  /**
   * The current location of the user. If null, the SDK automatically retrieves the current device
  ...
  public static class Builder {
    ...
    /**
     * Sets the current user location. This parameter is optional. If a location is not provided,
     * the SDK automatically retrieves the current device location using {@link
    ...
    /**
     * Sets the scan mode to be used. When creating a current place request, the SDK scans for
     * nearby Wi-Fi access points and Bluetooth Low Energy beacons. This parameter determines the
     * behavior of that scan. High accuracy is the default value. In order to use low latency, you
     * must specify a location on this builder.
     *
    ...
    /**
     * Specifies a field to be added to the response. Refer to {@link PlaceFields} for a list of
     * known place fields. Refer to the online Places Graph documentation for an up to date list of
     * fields.
     *
