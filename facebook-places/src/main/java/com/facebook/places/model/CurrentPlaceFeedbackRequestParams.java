...
/**
 * Describes the parameters used to create a current place feedback request with {@link
...
public class CurrentPlaceFeedbackRequestParams {
  ...
  /**
   * Gets the tracking ID. The tracking value is returned in the response of the current place
   * request {@link com.facebook.places.PlaceManager}
   *
  ...
  /**
   * Indicates whether the user was actually located at the place specified by {@code getPlaceId()}.
   * Could return null if {@code wasHere} was not set on the {@link Builder}.
   *
   * @return {@code true} if the user was at the place specified by getPlaceId(), {@false} if not,
  ...
  public static class Builder {
    ...
    /**
     * Indicates whether the user was actually located at the place specified by {@code
     * setPlaceId()}.
     *
     * @param wasHere {@code true} if the user was at the place specified by {@code setPlaceId()}
     * @return the builder
     */
    ...
    /**
     * Sets the tracking ID. The tracking ID value is returned in the response of the current place
     * request. See {@link com.facebook.places.PlaceManager} for information on how to place a
     * current place request.
     *
