...
public class SettingsFragment extends ListFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    slotManager.restore(
        ...
        savedInstanceState != null
            ...
            : SlotManager.NO_SLOT);
    ArrayList<Slot> slotList = new ArrayList<Slot>(Arrays.asList(slotManager.getAllSlots()));
  ...
  private class SlotAdapter extends ArrayAdapter<Slot> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      if (null == convertView) {
        convertView =
            getActivity().getLayoutInflater().inflate(R.layout.list_item_user, parent, false);
      }
      ...
      ProfilePictureView profilePic = (ProfilePictureView) convertView.findViewById(R.id.slotPic);
      if (userId != null) {
      ...
      TextView userNameTextView = (TextView) convertView.findViewById(R.id.slotUserName);
      userNameTextView.setText(userName);

      final CheckBox currentUserCheckBox =
          (CheckBox) convertView.findViewById(R.id.currentUserIndicator);
