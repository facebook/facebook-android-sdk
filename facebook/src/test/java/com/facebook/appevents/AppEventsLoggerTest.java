...
public class AppEventsLoggerTest extends FacebookPowerMockTestCase {
  ...
  public void testAppEventsLoggerLogFunctions() throws Exception {
    ...
    Mockito.verify(logger, Mockito.times(1))
        .logPurchase(Matchers.eq(mockVal), Matchers.eq(mockCurrency));
  ...
  public void testAutoLogAppEventsEnabled() throws Exception {
    ...
    PowerMockito.verifyNew(AppEventsLoggerImpl.class)
        .withArguments(Matchers.any(), Matchers.eq(mockAppID), Matchers.any());
  }
  ...
  public void testAutoLogAppEventsDisabled() throws Exception {
    ...
    PowerMockito.verifyNew(AppEventsLoggerImpl.class, Mockito.never())
  ...
  public void testUserIDAddedToAppEvent() throws Exception {
    ...
    PowerMockito.doReturn(true)
        .when(AttributionIdentifiers.class, "isTrackingLimited", Matchers.any(Context.class));
  ...
  public void testActivateApp() throws Exception {
    ...
    Mockito.verify(mockApplication, Mockito.times(1))
  ...
  public void testSetPushNotificationsRegistrationId() throws Exception {
    ...
    PowerMockito.doCallRealMethod()
        .when(AppEventsLoggerImpl.class, "setPushNotificationsRegistrationId", mockNotificationId);
