...
public class InAppPurchaseAutoLoggerTest extends FacebookPowerMockTestCase {
  private final Executor mockExecutor = new FacebookPowerMockTestCase.FacebookSerialExecutor();
  ...
  @Test
  public void testStartIapLogging() {
