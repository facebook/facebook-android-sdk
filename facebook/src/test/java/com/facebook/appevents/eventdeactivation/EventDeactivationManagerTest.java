...
public class EventDeactivationManagerTest extends FacebookPowerMockTestCase {
  ...
  public void testProcessEvents() throws JSONException {
    ...
    Whitebox.setInternalState(EventDeactivationManager.class, "deprecatedEvents", deprecatedEvents);
  ...
  public void testProcessDeprecatedParameters() {
    ...
    mockDeprecatedParams.add(
        new EventDeactivationManager.DeprecatedParamFilter(
            "fb_restrictive_event", mockDeprecatedParam));
    ...
    EventDeactivationManager.processDeprecatedParameters(mockEventParam, "fb_restrictive_event");
