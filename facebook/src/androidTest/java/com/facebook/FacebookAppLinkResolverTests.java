...
public class FacebookAppLinkResolverTests extends FacebookTestCase {
  ...
  public void testUrlWithNoAppLinkData() {
    ...
    try {
      ...
      assertTrue(
          singleUrlResolveTask.isCompleted()
  ...
  public void executeResolverOnBlockerThread(
      final FacebookAppLinkResolver resolver, final Uri testUrl) {
              ...
              resolveTask.continueWith(
                  new Continuation() {
                    ...
                    public Object then(Task task) throws Exception {
                      // Once the task is complete, unblock the test thread, so it can inspect for
                      // errors/results.
                      blocker.signal();
                      return null;
                    }
  ...
  private static boolean targetListsAreEqual(
      List<AppLink.Target> list1, List<AppLink.Target> list2) {
    if (list1 == null) {
      return list2 == null;
