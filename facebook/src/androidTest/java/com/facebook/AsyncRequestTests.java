...
public class AsyncRequestTests extends FacebookTestCase {
  ...
  public void testExecuteBatchWithNullRequestThrows() throws Exception {
    try {
      TestGraphRequestAsyncTask task = new TestGraphRequestAsyncTask(new GraphRequest[] {null});
  ...
  public void testExecuteSingleGetFailureCase() {
    ...
    GraphRequest request =
        new GraphRequest(accessToken, "-1", null, null, new ExpectFailureCallback());
  ...
  public void testMixedSuccessAndFailure() {
    ...
    for (int i = 0; i < NUM_REQUESTS; ++i) {
      ...
      if (shouldSucceed) {
        requests[i] = new GraphRequest(accessToken, "me", null, null, new ExpectSuccessCallback());
      } else {
        requests[i] = new GraphRequest(accessToken, "-1", null, null, new ExpectFailureCallback());
      }
    }
  ...
  public void testBatchUploadPhoto() {
    ...
    TestGraphRequestAsyncTask task =
        new TestGraphRequestAsyncTask(uploadRequest1, uploadRequest2, getRequest1, getRequest2);
    task.executeOnBlockerThread();
  ...
  public void testShortTimeoutCausesFailure() {
    ...
    GraphRequest request =
        new GraphRequest(accessToken, "me/likes", null, null, new ExpectFailureCallback());
  ...
  public void testLongTimeoutAllowsSuccess() {
    ...
    GraphRequest request =
        new GraphRequest(accessToken, "me", null, null, new ExpectSuccessCallback());
