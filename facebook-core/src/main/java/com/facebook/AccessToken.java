 ...
 *
 * <p>For more information on access tokens, see <a
...
public final class AccessToken implements Parcelable {
  ...
  public AccessToken(
      ...
      @Nullable final Date lastRefreshTime,
      @Nullable final Date dataAccessExpirationTime,
      @Nullable final String graphDomain) {
  ...
  /**
   * Updates the current access token with up to date permissions, and extends the expiration date,
   ...
   * Facebook application in order to launch a native link. For more information on native linking,
  ...
  public static void createFromNativeLinkingIntent(
    ...
    if (userId == null || userId.isEmpty()) {
      ...
      accessTokenCallback.onSuccess(
          createFromBundle(
              null, extras, AccessTokenSource.FACEBOOK_APPLICATION_WEB, new Date(), applicationId));
    }
  }
  ...
  public boolean equals(Object other) {
    ...
    return expires.equals(o.expires)
        ...
        && (graphDomain == null ? o.graphDomain == null : graphDomain.equals(o.graphDomain));
  }
  ...
  static AccessToken createFromRefresh(AccessToken current, Bundle bundle) {
    ...
    Date dataAccessExpirationTime =
        Utility.getBundleLongAsDate(bundle, DATA_ACCESS_EXPIRATION_TIME, new Date(0));
  ...
  AccessToken(Parcel parcel) {
    ...
    permissionsList.clear();
    parcel.readStringList(permissionsList);
    this.expiredPermissions = Collections.unmodifiableSet(new HashSet<String>(permissionsList));
