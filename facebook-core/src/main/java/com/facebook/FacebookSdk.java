...
public final class FacebookSdk {
   ...
   *     after it in your other requests. @Deprecated {@link #sdkInitialize(Context)} and {@link
   *     AppEventsLogger#activateApp(Application)} are called automatically on application start.
   ...
   *     can be set in the AndroidManifest as a meta data entry with the name {@link
   *     #CALLBACK_OFFSET_PROPERTY}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  public static synchronized void sdkInitialize(
      Context applicationContext, int callbackRequestCodeOffset) {
   ...
   *     is already initialized. @Deprecated {@link #sdkInitialize(Context)} and {@link
   *     AppEventsLogger#activateApp(Application)} are called automatically on application start.
   *     Automatic event logging from 'activateApp' can be controlled via the
   *     'com.facebook.sdk.AutoLogAppEventsEnabled' manifest setting. The callbackRequestCodeOffset
   *     can be set in the AndroidManifest as a meta data entry with the name {@link
   ...
   * 'com.facebook.sdk.AutoLogAppEventsEnabled' manifest setting
   *
   * @param applicationContext The application context @Deprecated {@link #sdkInitialize(Context)}
   *     and {@link AppEventsLogger#activateApp(Application)} are called automatically on
  ...
  public static synchronized void sdkInitialize(
    ...
    if ((FacebookSdk.applicationContext instanceof Application)
      ...
      ActivityLifecycleTracker.startTracking(
          (Application) FacebookSdk.applicationContext, applicationId);
    }
   ...
   *
   * <p>Facebook SDK won't work before fully initialized.
   *
   ...
   * production.
   *
   * <p>Returns the types of extended logging that are currently enabled.
   *
   ...
   * production.
   *
   * <p>Enables a particular extended logging in the SDK.
   *
   ...
   * production.
   *
   * <p>Disables a particular extended logging behavior in the SDK.
   *
   ...
   * production.
   *
   * <p>Disables all extended logging behaviors.
   */
   ...
   *
   * <p>By default this uses AsyncTask Executor via reflection if the API level is high enough.
   ...
   *
   * <p>This is required for PlatformDialogs which always need to use facebook.com
   *
   ...
   *
   * <p>This checks the current Access Token (if any) and returns the correct domain to use.
   *
   ...
   *
   * <p>Updating this will also affect getGraphDomain calls. Setting "beta.facebook.com" will return
   ...
   *     <p>When flag is false, SDK is not fully initialized.
   */
  ...
  /**
   * Sets the auto logging events flag for the application {@link
   * com.facebook.appevents.AppEventsLogger}
   *
   * @param flag true or false
   *     <p>When flag is false, events will not be logged, see {@link
