...
public final class FetchedAppSettingsManager {
  ...
  public static void loadAppSettingsAsync() {
    ...
    boolean canStartLoading =
        loadingState.compareAndSet(NOT_LOADED, LOADING)
  ...
  protected static FetchedAppSettings parseAppSettingsFromJSON(
    ...
    boolean codelessEventsEnabled = (featureBitmask & CODELESS_EVENTS_ENABLED_BITMASK_FIELD) != 0;
    boolean trackUninstallEnabled = (featureBitmask & TRACK_UNINSTALL_ENABLED_BITMASK_FIELD) != 0;
    boolean monitorEnabled = (featureBitmask & MONITOR_ENABLED_BITMASK_FIELD) != 0;
  ...
  private static Map<String, Map<String, FetchedAppSettings.DialogFeatureConfig>>
      parseDialogConfigurations(JSONObject dialogConfigResponse) {
