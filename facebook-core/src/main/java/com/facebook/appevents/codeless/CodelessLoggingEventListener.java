...
public class CodelessLoggingEventListener {
  ...
  public static AutoLoggingOnClickListener getOnClickListener(
      EventBinding mapping, View rootView, View hostView) {
    return new AutoLoggingOnClickListener(mapping, rootView, hostView);
  }

  public static AutoLoggingOnItemClickListener getOnItemClickListener(
  ...
  public static class AutoLoggingOnClickListener implements View.OnClickListener {
    ...
    private AutoLoggingOnClickListener(
        final EventBinding mapping, final View rootView, final View hostView) {
  ...
  public static class AutoLoggingOnItemClickListener implements AdapterView.OnItemClickListener {
    ...
    private AutoLoggingOnItemClickListener(
        final EventBinding mapping, final View rootView, final AdapterView hostView) {
      if (null == mapping || null == rootView || null == hostView) {
        return;
      }
