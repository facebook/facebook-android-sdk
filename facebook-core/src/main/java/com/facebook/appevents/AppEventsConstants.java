...
public class AppEventsConstants {
   ...
   */
  @Deprecated public static final String EVENT_NAME_PURCHASED = "fb_mobile_purchase";
  ...
  /**
   * Parameter key used to specify currency used with logged event. E.g. "USD", "EUR", "GBP". See <a
   * href="http://en.wikipedia.org/wiki/ISO_4217">ISO-4217</a> for specific values.
   */
