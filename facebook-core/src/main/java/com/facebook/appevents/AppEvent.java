...
public class AppEvent implements Serializable {
  ...
  private AppEvent(String jsonString, boolean isImplicit, boolean inBackground, String checksum)
  ...
  static class SerializationProxyV2 implements Serializable {
    ...
    private SerializationProxyV2(
        String jsonString, boolean isImplicit, boolean inBackground, String checksum) {
      this.jsonString = jsonString;
      this.isImplicit = isImplicit;
      this.inBackground = inBackground;
      this.checksum = checksum;
  ...
  public String toString() {
    return String.format(
        "\"%s\", implicit: %b, json: %s",
        jsonObject.optString("_eventName"), isImplicit, jsonObject.toString());
  }
