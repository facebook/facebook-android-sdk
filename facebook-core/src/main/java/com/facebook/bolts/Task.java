...
public class Task<TResult> {
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    com.facebook.bolts.TaskCompletionSource<TResult> tcs =
        new com.facebook.bolts.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(
    ...
    final com.facebook.bolts.TaskCompletionSource<Void> tcs =
        new com.facebook.bolts.TaskCompletionSource<>();
  ...
  public static <TResult> Task<TResult> call(
    ...
    final com.facebook.bolts.TaskCompletionSource<TResult> tcs =
        new com.facebook.bolts.TaskCompletionSource<>();
    try {
      executor.execute(
          new Runnable() {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(
    ...
    final com.facebook.bolts.TaskCompletionSource<Task<TResult>> firstCompleted =
        new com.facebook.bolts.TaskCompletionSource<>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final com.facebook.bolts.TaskCompletionSource<Task<?>> firstCompleted =
        new com.facebook.bolts.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final com.facebook.bolts.TaskCompletionSource<Void> allFinished =
        new com.facebook.bolts.TaskCompletionSource<>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final com.facebook.bolts.TaskCompletionSource<TContinuationResult> tcs =
        new com.facebook.bolts.TaskCompletionSource<>();
    synchronized (lock) {
  ...
  /** @deprecated Please use {@link com.facebook.bolts.TaskCompletionSource} instead. */
