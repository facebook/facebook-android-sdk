...
class SessionLoggerTest : FacebookPowerMockTestCase() {
    ...
    fun init() {
        ...
        whenever(mockPackageManager.getPackageInfo(any<String>(), any<Int>())).thenReturn(
            mockPackageInfo
        )
    ...
    fun `logDeactivateApp when sessionInfo is not null and interruptionDurationMillis is negative`() {
        ...
        val expectedValueToSum =
            mockSessionInfo.sessionLength.toDouble() / DateUtils.SECOND_IN_MILLIS
