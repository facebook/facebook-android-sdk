...
/** This class is created for inAppPurchase reflection testing. */
@AutoHandleExceptions
@RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
public class InAppPurchaseTestClass {
  private Object object;

  InAppPurchaseTestClass(Object object) {
    this.object = object;
  }

  public String inAppPurchaseTestMethod() {
    return "Test String";
  }
}
