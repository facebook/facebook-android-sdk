...
public class CreateAppGroupDialog
  ...
  public static void show(
      final Activity activity, final AppGroupCreationContent appGroupCreationContent) {
  ...
  @Deprecated
  public static void show(
      final Fragment fragment, AppGroupCreationContent appGroupCreationContent) {
  ...
  @Deprecated
  public static void show(
      final android.app.Fragment fragment, AppGroupCreationContent appGroupCreationContent) {
    show(new FragmentWrapper(fragment), appGroupCreationContent);
  }

  private static void show(
      final FragmentWrapper fragmentWrapper, AppGroupCreationContent appGroupCreationContent) {
  ...
  private class WebHandler extends ModeHandler {
    ...
    public AppCall createAppCall(final AppGroupCreationContent content) {
      ...
      DialogPresenter.setupAppCallForWebDialog(
          appCall, GAME_GROUP_CREATION_DIALOG, WebDialogParameters.create(content));
