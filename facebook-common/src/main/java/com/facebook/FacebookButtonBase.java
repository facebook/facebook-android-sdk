...
public abstract class FacebookButtonBase extends Button {
   ...
   * Fragment, and will allow the fragment to receive the {@link Fragment#onActivityResult(int, int,
   * android.content.Intent) onActivityResult} call rather than the Activity.
   *
  ...
  private void parseTextAttributes(
    ...
    final TypedArray colorAttrs =
        context.getTheme().obtainStyledAttributes(attrs, colorResources, defStyleAttr, defStyleRes);
    try {
    ...
    final TypedArray gravityAttrs =
        context
            .getTheme()
            .obtainStyledAttributes(attrs, gravityResources, defStyleAttr, defStyleRes);
    try {
    ...
    final int attrsResources[] = {
      android.R.attr.textSize, android.R.attr.textStyle, android.R.attr.text,
    };
    final TypedArray a =
        context.getTheme().obtainStyledAttributes(attrs, attrsResources, defStyleAttr, defStyleRes);
    try {
