...
public class WebDialogParameters {
  ...
  public static Bundle create(AppGroupCreationContent appGroupCreationContent) {
    ...
    Utility.putNonEmptyString(
        webParams, ShareConstants.WEB_DIALOG_PARAM_NAME, appGroupCreationContent.getName());
  ...
  public static Bundle create(GameRequestContent gameRequestContent) {
    ...
    Utility.putCommaSeparatedStringList(
        webParams, ShareConstants.WEB_DIALOG_PARAM_TO, gameRequestContent.getRecipients());
    Utility.putNonEmptyString(
        webParams, ShareConstants.WEB_DIALOG_PARAM_TITLE, gameRequestContent.getTitle());
    Utility.putNonEmptyString(
        webParams, ShareConstants.WEB_DIALOG_PARAM_DATA, gameRequestContent.getData());
    ...
    Utility.putNonEmptyString(
        webParams, ShareConstants.WEB_DIALOG_PARAM_OBJECT_ID, gameRequestContent.getObjectId());
  ...
  public static Bundle create(ShareLinkContent shareLinkContent) {
    ...
    Utility.putNonEmptyString(
        params, ShareConstants.WEB_DIALOG_PARAM_QUOTE, shareLinkContent.getQuote());
  ...
  public static Bundle createBaseParameters(ShareContent shareContent) {
    ...
    if (shareHashtag != null) {
      Utility.putNonEmptyString(
          params, ShareConstants.WEB_DIALOG_PARAM_HASHTAG, shareHashtag.getHashtag());
    }
  ...
  public static Bundle createForFeed(ShareLinkContent shareLinkContent) {
    ...
    Utility.putNonEmptyString(
        webParams, ShareConstants.WEB_DIALOG_PARAM_NAME, shareLinkContent.getContentTitle());
  ...
  public static Bundle createForFeed(ShareFeedContent shareFeedContent) {
    ...
    Utility.putNonEmptyString(webParams, ShareConstants.FEED_TO_PARAM, shareFeedContent.getToId());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_LINK_PARAM, shareFeedContent.getLink());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_PICTURE_PARAM, shareFeedContent.getPicture());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_SOURCE_PARAM, shareFeedContent.getMediaSource());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_NAME_PARAM, shareFeedContent.getLinkName());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_CAPTION_PARAM, shareFeedContent.getLinkCaption());

    Utility.putNonEmptyString(
        webParams, ShareConstants.FEED_DESCRIPTION_PARAM, shareFeedContent.getLinkDescription());
