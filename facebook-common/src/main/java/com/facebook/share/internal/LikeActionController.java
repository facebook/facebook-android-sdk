...
public class LikeActionController {
  ...
  /** @deprecated LikeView is deprecated */
  @Deprecated public static final String ERROR_INVALID_OBJECT_ID = "Invalid Object Id";
  /** @deprecated LikeView is deprecated */
  @Deprecated
  ...
  public static boolean handleOnActivityResult(
    ...
    if (Utility.isNullOrEmpty(objectIdForPendingController)) {
      ...
      objectIdForPendingController =
          sharedPreferences.getString(LIKE_ACTION_CONTROLLER_STORE_PENDING_OBJECT_ID_KEY, null);
    }
    ...
    getControllerForObjectId(
        ...
        new CreationCallback() {
          ...
          public void onComplete(
              LikeActionController likeActionController, FacebookException error) {
            if (error == null) {
  ...
  public static void getControllerForObjectId(
      String objectId, LikeView.ObjectType objectType, CreationCallback callback) {
    if (!isInitialized) {
  ...
  private static void verifyControllerAndInvokeCallback(
    ...
    LikeView.ObjectType bestObjectType =
        ShareInternalUtility.getMostSpecificObjectType(objectType, likeActionController.objectType);
  ...
  /**
   * NOTE: This MUST be called ONLY via the CreateLikeActionControllerWorkItem class to ensure that
   * it happens on the right thread, at the right time.
   */
        ...
        new CallbackManagerImpl.Callback() {
          ...
          public boolean onActivityResult(int resultCode, Intent data) {
            return handleOnActivityResult(
                CallbackManagerImpl.RequestCodeOffset.Like.toRequestCode(), resultCode, data);
          }
        });
        ...
        new AccessTokenTracker() {
          ...
          protected void onCurrentAccessTokenChanged(
            ...
            if (currentAccessToken == null) {
              ...
              appContext
                  .getSharedPreferences(LIKE_ACTION_CONTROLLER_STORE, Context.MODE_PRIVATE)
                  .edit()
  ...
  private static void putControllerInMemoryCache(
      String objectId, LikeActionController controllerForObject) {
  ...
  /**
   * NOTE: This MUST be called ONLY via the SerializeToDiskWorkItem class to ensure that it happens
   * on the right thread, at the right time.
   */
  ...
  private static LikeActionController deserializeFromJson(String controllerJsonString) {
    ...
    try {
      ...
      int objectTypeInt =
          controllerJson.optInt(JSON_INT_OBJECT_TYPE_KEY, LikeView.ObjectType.UNKNOWN.getValue());
      ...
      JSONObject analyticsJSON =
          controllerJson.optJSONObject(JSON_BUNDLE_FACEBOOK_DIALOG_ANALYTICS_BUNDLE);
  ...
  private static String serializeToJson(LikeActionController controller) {
    ...
    try {
      ...
      controllerJson.put(
          JSON_STRING_LIKE_COUNT_WITHOUT_LIKE_KEY, controller.likeCountStringWithoutLike);
      controllerJson.put(
          JSON_STRING_SOCIAL_SENTENCE_WITH_LIKE_KEY, controller.socialSentenceWithLike);
      controllerJson.put(
          JSON_STRING_SOCIAL_SENTENCE_WITHOUT_LIKE_KEY, controller.socialSentenceWithoutLike);
      ...
      if (controller.facebookDialogAnalyticsBundle != null) {
        JSONObject analyticsJSON =
            BundleJSONConverter.convertToJSON(controller.facebookDialogAnalyticsBundle);
        if (analyticsJSON != null) {
  ...
  public void toggleLike(Activity activity, FragmentWrapper fragment, Bundle analyticsParameters) {
    ...
    if (canUseOGPublish()) {
      ...
      if (isPendingLikeOrUnlike) {
        ...
        getAppEventsLogger()
            .logEventImplicitly(
                AnalyticsEvents.EVENT_LIKE_VIEW_DID_UNDO_QUICKLY, analyticsParameters);
  ...
  /**
   * Only to be called after an OG-publish was attempted and something went wrong. The Button state
   * is reverted and an error is returned to the LikeViews
   */
  private void publishDidError(boolean oldLikeState) {
    ...
    broadcastAction(
        LikeActionController.this, ACTION_LIKE_ACTION_CONTROLLER_DID_ERROR, errorBundle);
  }
  ...
  private void updateState(
    ...
    boolean stateChanged =
        isObjectLiked != this.isObjectLiked
  ...
  private void presentLikeDialog(
    ...
    if (analyticsEvent != null) {
      ...
      getAppEventsLogger()
          .logEventImplicitly(
              AnalyticsEvents.EVENT_LIKE_VIEW_DID_PRESENT_DIALOG, analyticsParameters);
    }
  }
  ...
  private ResultProcessor getResultProcessor(final Bundle analyticsParameters) {
    return new ResultProcessor(null) {
      ...
      public void onSuccess(AppCall appCall, Bundle data) {
        ...
        getAppEventsLogger()
            .logEventImplicitly(AnalyticsEvents.EVENT_LIKE_VIEW_DIALOG_DID_SUCCEED, logParams);
  ...
  private void publishLikeAsync(final Bundle analyticsParameters) {
    ...
    fetchVerifiedObjectId(
        new RequestCompletionCallback() {
          @Override
          public void onComplete() {
            if (Utility.isNullOrEmpty(verifiedObjectId)) {
              ...
              errorBundle.putString(
                  NativeProtocol.STATUS_ERROR_DESCRIPTION, ERROR_INVALID_OBJECT_ID);
                ...
                new GraphRequestBatch.Callback() {
                  ...
                  public void onBatchCompleted(GraphRequestBatch batch) {
                    ...
                    if (likeRequest.getError() != null) {
                      ...
                      getAppEventsLogger()
                          .logEventImplicitly(
                              AnalyticsEvents.EVENT_LIKE_VIEW_DID_LIKE, null, analyticsParameters);
        ...
        new GraphRequestBatch.Callback() {
          ...
          public void onBatchCompleted(GraphRequestBatch batch) {
            ...
            if (unlikeRequest.getError() != null) {
              ...
              getAppEventsLogger()
                  .logEventImplicitly(
                      AnalyticsEvents.EVENT_LIKE_VIEW_DID_UNLIKE, null, analyticsParameters);
  ...
  private void refreshStatusViaService() {
    LikeStatusClient likeStatusClient =
        new LikeStatusClient(
            FacebookSdk.getApplicationContext(), FacebookSdk.getApplicationId(), objectId);
    if (!likeStatusClient.start()) {
      return;
    }

    LikeStatusClient.CompletedListener callback =
        new LikeStatusClient.CompletedListener() {
          @Override
          public void completed(Bundle result) {
            ...
            String likeCountWithoutLike =
                result.containsKey(ShareConstants.EXTRA_LIKE_COUNT_STRING_WITHOUT_LIKE)
                    ? result.getString(ShareConstants.EXTRA_LIKE_COUNT_STRING_WITHOUT_LIKE)
            ...
            String socialSentenceWithoutLike =
                result.containsKey(ShareConstants.EXTRA_SOCIAL_SENTENCE_WITHOUT_LIKE)
                    ? result.getString(ShareConstants.EXTRA_SOCIAL_SENTENCE_WITHOUT_LIKE)
                    : LikeActionController.this.socialSentenceWithoutLike;
  ...
  private void logAppEventForError(String action, FacebookRequestError error) {
    ...
    if (error != null) {
      ...
      if (requestResult != null) {
        logParams.putString(
            AnalyticsEvents.PARAMETER_LIKE_VIEW_ERROR_JSON, requestResult.toString());
      }
    }
  ...
  private class GetOGObjectIdRequestWrapper extends AbstractRequestWrapper {
    ...
    GetOGObjectIdRequestWrapper(String objectId, LikeView.ObjectType objectType) {
      ...
      setRequest(
          new GraphRequest(
              AccessToken.getCurrentAccessToken(), "", objectIdRequestParams, HttpMethod.GET));
    }
  ...
  private class GetPageIdRequestWrapper extends AbstractRequestWrapper {
    ...
    GetPageIdRequestWrapper(String objectId, LikeView.ObjectType objectType) {
      ...
      setRequest(
          new GraphRequest(
              AccessToken.getCurrentAccessToken(), "", pageIdRequestParams, HttpMethod.GET));
    }
  ...
  private class PublishUnlikeRequestWrapper extends AbstractRequestWrapper {
    ...
    PublishUnlikeRequestWrapper(String unlikeToken) {
      ...
      setRequest(
          new GraphRequest(
              AccessToken.getCurrentAccessToken(), unlikeToken, null, HttpMethod.DELETE));
    }
  ...
  private class GetOGObjectLikesRequestWrapper extends AbstractRequestWrapper
    ...
    GetOGObjectLikesRequestWrapper(String objectId, LikeView.ObjectType objectType) {
      ...
      setRequest(
          new GraphRequest(
              AccessToken.getCurrentAccessToken(), "me/og.likes", requestParams, HttpMethod.GET));
    }
          ...
          if (data != null) {
            ...
            if (appData != null
                ...
                && Utility.areObjectsEqual(
                    accessToken.getApplicationId(), appData.optString("id"))) {
  ...
  private class GetEngagementRequestWrapper extends AbstractRequestWrapper {
    ...
    GetEngagementRequestWrapper(String objectId, LikeView.ObjectType objectType) {
      ...
      setRequest(
          new GraphRequest(
              AccessToken.getCurrentAccessToken(), objectId, requestParams, HttpMethod.GET));
    }

    @Override
    protected void processSuccess(GraphResponse response) {
      JSONObject engagementResults =
          Utility.tryGetJSONObjectFromResponse(response.getJSONObject(), "engagement");
