...
public final class ShareMessengerMediaTemplateContent
    ...
    public static class Builder
        ...
        /**
         * Set the attachmentID of the item to share. Optional, but either attachmentID or mediaURL
         * must be specified.
         */
         ...
         * Facebook url.Optional, but either attachmentID or mediaURL must be specified.
