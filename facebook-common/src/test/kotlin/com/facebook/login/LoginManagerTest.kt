...
class LoginManagerTest : FacebookPowerMockTestCase() {
    ...
    @Mock
    lateinit var mockCallback: FacebookCallback<LoginResult>
    ...
    @Mock
    lateinit var mockAccessTokenCompanion: AccessToken.Companion

    @Mock
    lateinit var mockAuthenticationTokenCompanion: AuthenticationToken.Companion

    @Mock
    lateinit var mockProfileCompanion: Profile.Companion
    ...
    fun testLogInWithReadAndActivityThrowsIfPublishPermissionGiven() {
        ...
        loginManager.logInWithReadPermissions(
            mockActivity,
            listOf("public_profile", "publish_actions")
        )
    }
    ...
    fun `test retrieve login status if a correct result is received`() {
        ...
        LoginManager.getInstance()
            .retrieveLoginStatus(mockApplicationContext, mockLoginStatusCallback)
